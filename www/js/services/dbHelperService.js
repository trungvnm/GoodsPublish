    ...
    .factory('$dbHelper', function ($cordovaSQLite, $rootScope, $q) {
        var dbHelper = {
            ...
            initialDB: function () {
                ...
                var goodsPublish = "GoodPublishId integer primary key,UserId integer,Title text,Subtitle text,Condition text,Guid text,Price real,SalePrice real,msrp real,costprice real,SaleType text,Category integer,StoreCategory integer,Brand text,ShipWithin integer,ModelSkuCode text,State text,";
